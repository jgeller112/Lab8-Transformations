...
> Write up the interpretation of the centered model (intercept and slope)
...
> Write-up this model (focus on interperting the coefficients)
...
> Create a plot visualizing the realtionship between Fear and Enjoyment
...
> Do you think a linear model is a good fit to this data?
...
::: callout-note
While we do not find a significant quadratic relationship in this analysis, the paper does find one. This is because the paper looked at several scares and empolyed a more powerful  model. Nonetheless, hopefully you better understand how to test non-linear relationships in a  regression context
:::
